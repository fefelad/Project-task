      ...
      <div className={styles.containerFaq}>
        ...
        <div className={styles.faqContainer}>
          ...
          <FAQItem
              ...
              text="Занятия проходят онлайн. Онлайн — занятия в небольших группах с преподавателем и обратной связью."
          />
          ...
          <FAQItem
              ...
              text="Для онлайн — компьютер и интернет. Мы поможем установить все программы."
          />
        </div>
      </div>
    </>
