    ...
    <>
      <div className={styles.container_homepage}>
        <div className={styles.imageWrapper}>
          <picture>
            <source media="(max-width: 1000px)" srcSet={Media500} />
            <img
              src={PeopleHomePage}
              alt="Ребенок"
        ...
        <Text size={TextSizes.XL2} className={styles.shoolText_desc}>
          Ваш ребенок освоит основы композиции, цвета и шрифтов <br className={styles.br} /> — то,
      ...
      <div className={styles.containerFaq}>
        ...
        <div className={styles.faqContainer}>
          <FAQItem
              title="Что получит ребенок после курса?"
              text="Ребенок освоит базовые принципы дизайна композиция, цвет, шрифты и применит их в практических заданиях. В конце у него будет набор готовых работ, а у вас — понятное понимание прогресса."
          />

          <FAQItem
              title="Подойдет ли курс, если ребенок никогда не занимался дизайном?"
              text="Да, курс подходит для новичков. Все темы объясняются простым языком и закрепляются на практике."
          />

          <FAQItem
              title="Как проходят занятия: онлайн и офлайн?"
              text="Можно выбрать удобный формат. Онлайн — занятия в небольших группах с преподавателем и обратной связью. Офлайн — живые уроки в классе с практикой и разбором работ."
          />

          <FAQItem
              title="Сколько времени нужно и будет ли нагрузка?"
              text="Занятия проходят 2 раза в неделю по 60–90 минут. Нагрузка комфортная: больше практики, чем теории. Домашние задания небольшие и без стресса."
          />

          <FAQItem
              title="Что нужно для старта?"
              text="Для онлайн — компьютер и интернет. Мы поможем установить все программы. Для офлайн — просто прийти на занятие, всё остальное предоставим."
          />
        </div>
      </div>
    </>
