        ...
        <div className={styles.ContacPageContainer}>
            ...
            <div className={styles.MainContentContactPage}>
                <Text fontFamily='onest' size={TextSizes.XL2}>
                    Мы находимся в Санкт‑Петербурге и Москве — можно выбрать ближайшую филиал и записаться на очную консультацию.
                </Text>
                <Text fontFamily='onest' size={TextSizes.XL2}>
                    На этой странице собраны адреса филиалов, схема проезда и контакты для записи. 
                </Text>
                <Text fontFamily='onest' size={TextSizes.XL2}>
                    Если удобнее, напишите заранее — подскажем, как добраться, где припарковаться и что взять с собой.
                </Text>
            </div>
