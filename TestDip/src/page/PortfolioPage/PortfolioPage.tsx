      ...
      <div className={styles.promoProtfolioBlock}>
        ...
        <div className={styles.promoblock}>
          <Text fontFamily="onest" className={styles.promoProtfoliodesk}>
            Работы наших учеников — это не “просто картинки”, а продуманные проекты,
            где видно рост: от идеи и наброска до аккуратного digital-результата.
          </Text>
          ...
          <Masonry columns={{ xs: 1, sm: 2, md: 3 }} spacing={3}>
            {portfolioItems.map((item) => (
              <div key={item.id} className={styles.portfolioCard}>
                <img src={item.img} alt={item.alt} className={styles.portfolioCardImage} />
