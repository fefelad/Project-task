  ...
  return (
    <section className={styles.coursesSection}>
      ...
      <div className={styles.coursesGrid}>
        ...
        Обучение построено по трём уровням сложности, чтобы ребёнок двигался постепенно и не перегружался. Сначала
        он знакомится с базовыми инструментами и простыми заданиями, затем учится делать работы аккуратнее и выразительнее,
        а на продвинутом уровне собирает собственный мини-проект.
        </Text>
        ...
        <Text fontFamily="onest" className={styles.descriptionBottom}>
          На занятиях много практики, а результат виден в готовых работах, которые можно собрать в небольшое портфолио. Проходят в удобном темпе и с понятной обратной связью.
        </Text>
      </div>
